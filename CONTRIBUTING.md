...
> [Documentation](https://github.com/gregyjames/LeaderElection).

Before you ask a question, it is best to search for existing
[Issues](https://github.com/gregyjames/LeaderElection/issues) that might help you. In case you have
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible
  ...
  [documentation](https://github.com/gregyjames/LeaderElection). If you are looking for support, you
...
- To see if other users have experienced (and potentially already solved) the same issue you are
  ...
  [bug tracker](https://github.com/gregyjames/LeaderElection/issues?q=label%3Abug).
...
- Open an [Issue](https://github.com/gregyjames/LeaderElection/issues/new). (Since we can't be sure
  at this point whether it is a bug or not, we ask you not to talk about a bug yet and not to label
  the issue.)
...
This section guides you through submitting an enhancement suggestion for LeaderElection, **including
...
- Make sure that you are using the latest version.
- Read the [documentation](https://github.com/gregyjames/LeaderElection) carefully and find out if
  the functionality is already covered, maybe by an individual configuration.
- Perform a [search](https://github.com/gregyjames/LeaderElection/issues) to see if the enhancement
...
[GitHub issues](https://github.com/gregyjames/LeaderElection/issues).
...
- You may want to **include screenshots or screen recordings** which help you demonstrate the steps
  ...
  [LICEcap](https://www.cockos.com/licecap/) to record GIFs on macOS and Windows, and the built-in
...
- **Explain why this enhancement would be useful** to most LeaderElection users. You may also want
