...
public class DistributedCacheSettingsValidator: BaseSettingsValidator<DistributedCacheSettings>, IValidateOptions<DistributedCacheSettings>
{
    public ValidateOptionsResult Validate(string? name, DistributedCacheSettings options)
    {
